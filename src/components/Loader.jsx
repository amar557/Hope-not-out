...
function Loader() {
  return (
    <div className="relative flex w-full animate-pulse gap-2 p-4">
      <div className="h-72 w-3/5  bg-slate-400 rounded-lg"></div>
      <div className="flex-1">
        <div className="mb-2 h-10 w-3/5 rounded-lg bg-slate-400 text-lg"></div>
        <div className="h-12 w-2/5 mb-2 rounded-lg bg-slate-400 text-sm"></div>
      ...
      <div className="absolute bottom-5 right-[38%] h-6 w-6 rounded-full bg-slate-400"></div>
    </div>
  );
}
